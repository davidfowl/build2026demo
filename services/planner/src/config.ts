// Module: runtime configuration helpers for planner and hosted-agent processes.
// Exports: service identity values, timing knobs, Copilot/Foundry paths and
// scope, plus helpers for required environment variables, URL normalization, and
// delays.
// Does: reads configuration injected by apphost.mts and validates required
// service-discovery values at startup.
// Why: keeps environment parsing centralized so worker modules fail fast when
// required Aspire/Foundry wiring is missing.
